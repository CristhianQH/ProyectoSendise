...
namespace ProyectoSen
{
    public partial class EquipoUser : Form
    {
        ...
        private void cmbTecnico_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (cmbTecnico.Text == "Cristhian")
            {

                Clases.CReporte objetoReporte = new Clases.CReporte();
                objetoReporte.SelecionarTecnicoE(dgvTecnico, cmbTecnico);
            }

            if (cmbTecnico.Text == "Luis")
            {
